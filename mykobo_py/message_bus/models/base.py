...
class EventType(str, Enum):
    ...
    MINT_INFO = "MINT_INFO"
    BURN_INFO = "BURN_INFO"
    TRANSACTION_FAILED_ALERT = "TRANSACTION_FAILED_ALERT"
    TRANSACTION_HELD_ALERT = "TRANSACTION_HELD_ALERT"
    BANK_PAYMENT_BALANCE_INSUFFICIENT_ALERT = "BANK_PAYMENT_BALANCE_INSUFFICIENT_ALERT"
    BANK_PAYMENT_EXECUTION_FAILED_ALERT = "BANK_PAYMENT_EXECUTION_FAILED_ALERT"
    BCB_WEBHOOK_PROCESSING_FAILED_ALERT = "BCB_WEBHOOK_PROCESSING_FAILED_ALERT"
    BENEFICIARY_CREATION_FAILED_ALERT = "BENEFICIARY_CREATION_FAILED_ALERT"
    BANK_PAYMENT_RECEIVED_INFO = "BANK_PAYMENT_RECEIVED_INFO"
    BANK_PAYMENT_SENT_INFO = "BANK_PAYMENT_SENT_INFO"
    ONCHAIN_PAYMENT_RECEIVED_INFO = "ONCHAIN_PAYMENT_RECEIVED_INFO"
    ONCHAIN_PAYMENT_SENT_INFO = "ONCHAIN_PAYMENT_SENT_INFO"
    CUSTOMER_FUNDS_RECEIVED = "CUSTOMER_FUNDS_RECEIVED"
    TRANSACTION_FUNDED_INFO = "TRANSACTION_FUNDED_INFO"
    TRANSACTION_APPROVED_INFO = "TRANSACTION_APPROVED_INFO"
    TRANSACTION_FULFILLED_INFO = "TRANSACTION_FULFILLED_INFO"
    PAYMENT_REFERENCE_CREATED = "PAYMENT_REFERENCE_CREATED"
